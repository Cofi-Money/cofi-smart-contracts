...
describe("Test wrappers in app context", function() {
    ...
    async function deploy() {
        ...
        // await wbt_btc.transfer((await backupOwner.getAddress()), "10000000") // 0.1 wBTC
        // console.log("Transferred wBTC to secondary user")
        ...
        // await cofiMoney.underlyingToFi(
        //     "3400000", // ~ $1,000
        //     "33915000000000000", // 0.25% slippage
        //     await fiBTC.getAddress(),
        //     await owner.getAddress(),
        //     await owner.getAddress(),
        //     NULL_Addr
        ...
        return {
            owner, feeCollector, signer, wueSigner, backupSigner, backupOwnerAddr,
            wbtSigner,
            wyvUSDC,
            wyvETH, wsoBTC,
            fiUSD,
